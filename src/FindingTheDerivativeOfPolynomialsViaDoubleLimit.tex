...
\title[Finding the derivative of polynomials via double limit]
...
\keywords{
    Polynomials, Limits, Binomial theorem, Binomial expansion, Binomial coefficients,
    Derivatives, Differentiation, Polynomial identities
}
\subjclass[2010]{26A24, 26E70, 05A30}
\date{\today}
\hypersetup{
    pdftitle={Differentiation of polynomials via double limit},
    pdfsubject={
        Polynomials,
        Limits,
        Binomial theorem,
...
\begin{document}
    ...
    \freefootnote{Sources: \url{https://github.com/kolosovpetro/FindingTheDerivativeOfPolynomialsViaDoubleLimit}}
    ...
    \input{sections/04_verification_of_the_results}

    \bibliographystyle{unsrt}
    \bibliography{FindingTheDerivativeOfPolynomialsViaDoubleLimit}
